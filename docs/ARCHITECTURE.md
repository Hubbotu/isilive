...
5. `tools/validate_usecases.lua` fuehrt beide Validatoren zuerst aus und deckt danach 561 Szenarien ueber 40 Module ab; die Regelvalidatoren indizieren aktuell 561 deterministische Tests.
...
```text
| isiLive                                                 v0.9.154 Open/Close CTRL-F9 [H][V][M][M2][L][X]|
|---------------------------------------------------------------------------------------------------|

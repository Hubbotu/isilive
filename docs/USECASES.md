...
6. Die optionalen `Esc`-Tooling-, Travel- und Addons-Strips sind aktiv, solange der User sie nicht explizit in den Addon-Settings deaktiviert.
...
Aktuelle Validator-Baseline: `1796` Szenarien ueber die in `tools/usecase_scenarios.lua` registrierten Module.
...
11. UC-13 und UC-14: Game-Menu-Tooling-/Travel-/Addons-Strips, Lokalisierung inklusive ruRU-Font-Override, Close-then-Open-Verhalten, verschobener Secure-Reload-Button-Refresh, Direct-Opener-Fallback-Auswahl, Settings-Canvas-State-Mirroring, Background-Opacity-Verhalten, Live-BRes-/Bloodlust-/M+-Timer-Rendering, M+-Killtracker-Live-Refresh und gesyncte Interrupt-Cooldown-Anzeige.
...
| Esc-Tooling-/Travel-/Addons-Strips und Blizzard-Settings-Canvas | `isiLive_ui.lua`, `isiLive_settings.lua`, `isiLive_factory.lua`, `isiLive_texts.lua`, `isiLive_ui_common.lua` |

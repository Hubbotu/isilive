...
`tools/validate_usecases.lua` ist Pflicht fuer das Release-Gate, fuehrt beide Regelvalidatoren zuerst aus und validiert danach 574 Szenarien ueber 42 Module. Die Regelvalidatoren indizieren aktuell 574 deterministische Tests.

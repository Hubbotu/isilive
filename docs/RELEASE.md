...
`tools/validate_usecases.lua` ist Pflicht fuer das Release-Gate, fuehrt beide Regelvalidatoren zuerst aus und validiert danach 602 Szenarien ueber 45 Module. Die Regelvalidatoren indizieren aktuell 602 deterministische Tests.

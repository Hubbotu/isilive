...
`tools/validate_usecases.lua` ist Pflicht fuer das Release-Gate, fuehrt beide Regelvalidatoren zuerst aus und validiert danach 619 Szenarien ueber 45 Module. Die Regelvalidatoren indizieren aktuell 619 deterministische Tests.

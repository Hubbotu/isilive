...
- **Tests:**
  ...
  - 758 / 758 use-case scenarios pass. Stylua, luacheck, syntax, metrics, locale drift, lifetime gate and the deterministic usecase/rules logic validator are all green on the full local preflight.

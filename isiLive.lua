...
local function BuildSeason3TeleportNameCache()
    ...
    for aliasName, mapID in pairs(SEASON3_NAME_ALIASES) do
    ...
    if activityID and C_LFGList and C_LFGList.GetActivityInfoTable then
        ...
        if info then
            ...
            if mapID and SEASON3_MAP_TO_TELEPORT[mapID] then
                return SEASON3_MAP_TO_TELEPORT[mapID]
            end
...
local function ResolveActiveTeleportSpellID()
    ...
    if C_ChallengeMode and C_ChallengeMode.GetActiveChallengeMapID then
        ...
        if activeMapID and SEASON3_MAP_TO_TELEPORT[activeMapID] then
            return SEASON3_MAP_TO_TELEPORT[activeMapID]
        end
    ...
    if instanceType == "party" then
        if instanceMapID and SEASON3_MAP_TO_TELEPORT[instanceMapID] then
            return SEASON3_MAP_TO_TELEPORT[instanceMapID]
        end
